...
_app_env_fields = (
    "llm_provider", "moonshot_api_key", "moonshot_base_url", "moonshot_model_name",
    ...
    "grok_api_key", "grok_base_url", "grok_model_name",
    "minimax_api_key", "minimax_base_url", "minimax_model_name",
    "mimo_api_key", "mimo_base_url", "mimo_model_name",
    "shengsuanyun_api_key", "shengsuanyun_base_url", "shengsuanyun_model_name",
    "apimart_api_key", "apimart_base_url", "apimart_model_name",
    "fluxionai_api_key", "fluxionai_base_url", "fluxionai_model_name",
    "aihubmix_api_key", "aihubmix_base_url", "aihubmix_model_name",
    "aimlapi_api_key", "aimlapi_base_url", "aimlapi_model_name",
    "evolink_api_key", "evolink_base_url", "evolink_model_name",
    "openrouter_api_key", "openrouter_base_url", "openrouter_model_name",
    "api_route_api_key", "api_route_base_url", "api_route_model_name",
    "ollama_base_url", "ollama_model_name",
    "claude_code_model_name", "claude_code_cli_path", "claude_code_timeout",
    "oneapi_api_key", "oneapi_base_url", "oneapi_model_name",
    "litellm_model_name",
    "groq_api_key", "groq_base_url", "groq_model_name",
    "pollinations_api_key", "pollinations_base_url", "pollinations_model_name",
    "cloudflare_api_key", "cloudflare_account_id", "cloudflare_gateway_id", "cloudflare_model_name",
    "modelscope_api_key", "modelscope_base_url", "modelscope_model_name",
    "pexels_api_keys", "pixabay_api_keys", "coverr_api_keys",
    "wavespeed_api_keys",
    "volcengine_seedance_api_key", "volcengine_seedance_base_url",
    "volcengine_seedance_model", "volcengine_seedance_resolution",
    "ofox_api_key", "ofox_base_url", "ofox_text_to_video_model", "ofox_resolution",
    "metaso_minimax_api_key", "metaso_minimax_base_url", "metaso_minimax_resolution",
    "muapi_api_key", "muapi_base_url", "muapi_video_endpoint", "muapi_resolution",
    "openai_image_base_url", "openai_image_api_keys", "openai_image_model",
    "openai_image_size", "openai_image_prompt_template",
    "sonilo_api_key", "sonilo_base_url",
    "video_source", "subtitle_provider", "endpoint", "api_key",
...
_section_env_map = {
    ...
    "siliconflow": ("api_key",),
    "minimax_tts": ("api_key", "base_url", "model_id", "voice_id"),
    "elevenlabs": ("api_key", "model_id", "music_base_url", "music_model_id"),
    "chatterbox": ("base_url", "api_key", "model_id"),
    "kokoro": ("base_url", "api_key", "model_id"),
    "fish_audio": ("api_key", "model"),
    "voxcpm": ("base_url", "api_key", "model_id", "voice_id"),
}


def _try_parse_json_list(value):
...
def _apply_env_overrides_to_config(cfg):
    """Overlay MPT_<SECTION>_<FIELD> env vars so Railway can inject credentials."""
    for section, fields in _section_env_map.items():
        section_prefix = f"MPT_{section.upper()}_"
        for field in fields:
            env_name = f"{section_prefix}{field.upper()}"
            env_value = os.environ.get(env_name)
            if env_value is None or env_value.strip() == "":
                continue
            if "api_keys" in field or field == "openai_image_api_keys":
                env_value = _try_parse_json_list(env_value)
                if isinstance(env_value, str):
                    env_value = [env_value]
            cfg.setdefault(section, {})[field] = env_value
    return cfg


_cfg = load_config()
_cfg = _apply_env_overrides_to_config(_cfg)
